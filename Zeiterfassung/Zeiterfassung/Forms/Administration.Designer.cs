namespace Zeiterfassung
{
    partial class Administration
    {
        ...
        private void InitializeComponent()
        {
			...
			this.ku_new_Butt = new System.Windows.Forms.Button();
			...
			this.thät_Box = new System.Windows.Forms.ListBox();
			...
			// kunden_Tab
			// 
			this.kunden_Tab.Controls.Add(this.ku_Delete_Butt);
			...
			this.kunden_Tab.Controls.Add(this.ku_new_Butt);
			...
			// ku_Delete_Butt
			// 
			this.ku_Delete_Butt.Location = new System.Drawing.Point(423, 67);
			this.ku_Delete_Butt.Name = "ku_Delete_Butt";
			this.ku_Delete_Butt.Size = new System.Drawing.Size(95, 23);
			this.ku_Delete_Butt.TabIndex = 24;
			this.ku_Delete_Butt.Text = "Löschen";
			...
			// ku_new_Butt
			// 
			this.ku_new_Butt.Location = new System.Drawing.Point(423, 8);
			this.ku_new_Butt.Name = "ku_new_Butt";
			this.ku_new_Butt.Size = new System.Drawing.Size(95, 23);
			this.ku_new_Butt.TabIndex = 2;
			this.ku_new_Butt.Text = "Neuer Kunde";
			this.ku_new_Butt.UseVisualStyleBackColor = true;
			this.ku_new_Butt.Click += new System.EventHandler(this.ku_New_Butt_Click);
			// 
			// label1
			// 
			...
			this.mitarbeiter_Tab.Controls.Add(this.button10);
			this.mitarbeiter_Tab.Controls.Add(this.button9);
			this.mitarbeiter_Tab.Controls.Add(this.button8);
			this.mitarbeiter_Tab.Controls.Add(this.button7);
			...
			this.mitarbeiter_Tab.Controls.Add(this.telTB);
			...
			// button10
			// 
			this.button10.Location = new System.Drawing.Point(10, 153);
			this.button10.Name = "button10";
			this.button10.Size = new System.Drawing.Size(115, 34);
			this.button10.TabIndex = 15;
			this.button10.Text = "Passwort zurücksetzen";
			this.button10.UseVisualStyleBackColor = true;
			// 
			// button9
			// 
			this.button9.Location = new System.Drawing.Point(394, 123);
			this.button9.Name = "button9";
			this.button9.Size = new System.Drawing.Size(124, 23);
			this.button9.TabIndex = 14;
			this.button9.Text = "Mitarbeiter entfernen";
			this.button9.UseVisualStyleBackColor = true;
			// 
			// button8
			// 
			this.button8.Location = new System.Drawing.Point(261, 123);
			this.button8.Name = "button8";
			this.button8.Size = new System.Drawing.Size(127, 23);
			this.button8.TabIndex = 13;
			this.button8.Text = "Neuer Mitarbeiter";
			...
			// mailTB
			// 
			this.mailTB.Location = new System.Drawing.Point(56, 92);
			this.mailTB.Name = "mailTB";
			this.mailTB.Size = new System.Drawing.Size(346, 20);
			...
			// telTB
			// 
			this.telTB.Location = new System.Drawing.Point(56, 64);
			this.telTB.Name = "telTB";
			this.telTB.Size = new System.Drawing.Size(346, 20);
			...
			// vornameTB
			// 
			this.vornameTB.Location = new System.Drawing.Point(261, 38);
			this.vornameTB.Name = "vornameTB";
			this.vornameTB.Size = new System.Drawing.Size(141, 20);
			this.vornameTB.TabIndex = 5;
			// 
			// label10
			// 
			...
			this.nameTB.Size = new System.Drawing.Size(141, 20);
			...
			// projekt_Tab
			// 
			this.projekt_Tab.Controls.Add(this.button6);
			this.projekt_Tab.Controls.Add(this.button5);
			this.projekt_Tab.Controls.Add(this.button4);
			this.projekt_Tab.Controls.Add(this.button3);
			this.projekt_Tab.Controls.Add(this.button2);
			this.projekt_Tab.Controls.Add(this.label7);
			this.projekt_Tab.Controls.Add(this.thät_Box);
			...
			this.projekt_Tab.Controls.Add(this.comboBox2);
			...
			// button6
			// 
			this.button6.Location = new System.Drawing.Point(418, 356);
			this.button6.Name = "button6";
			this.button6.Size = new System.Drawing.Size(99, 34);
			this.button6.TabIndex = 16;
			this.button6.Text = "Tätigkeit bearbeiten";
			this.button6.UseVisualStyleBackColor = true;
			// 
			// button5
			// 
			this.button5.Location = new System.Drawing.Point(419, 407);
			this.button5.Name = "button5";
			this.button5.Size = new System.Drawing.Size(99, 34);
			this.button5.TabIndex = 15;
			this.button5.Text = "Tätigkeit entfernen";
			this.button5.UseVisualStyleBackColor = true;
			// 
			// button4
			// 
			this.button4.Location = new System.Drawing.Point(418, 259);
			this.button4.Name = "button4";
			this.button4.Size = new System.Drawing.Size(99, 41);
			this.button4.TabIndex = 14;
			this.button4.Text = "Mitarbeiter entfernen";
			...
			this.button3.Text = "Tätigkeit hinzufügen";
			...
			this.button2.Text = "Mitarbeiter zuweisen";
			...
			this.label7.Text = "Thätigkeiten:";
			// 
			// thät_Box
			// 
			this.thät_Box.FormattingEnabled = true;
			this.thät_Box.Location = new System.Drawing.Point(119, 307);
			this.thät_Box.Name = "thät_Box";
			this.thät_Box.Size = new System.Drawing.Size(293, 134);
			this.thät_Box.TabIndex = 10;
			// 
			// label6
			// 
			...
			this.mitarbeit_Box.Location = new System.Drawing.Point(119, 205);
			this.mitarbeit_Box.Name = "mitarbeit_Box";
			this.mitarbeit_Box.Size = new System.Drawing.Size(293, 95);
			this.mitarbeit_Box.TabIndex = 8;
			// 
			// beschr_Box
			// 
			this.beschr_Box.Location = new System.Drawing.Point(119, 95);
			this.beschr_Box.Multiline = true;
			this.beschr_Box.Name = "beschr_Box";
			this.beschr_Box.ReadOnly = true;
			this.beschr_Box.Size = new System.Drawing.Size(293, 103);
			this.beschr_Box.TabIndex = 7;
			// 
			// label5
			// 
			...
			// kund_Box
			// 
			this.kund_Box.Location = new System.Drawing.Point(119, 66);
			this.kund_Box.Name = "kund_Box";
			this.kund_Box.ReadOnly = true;
			this.kund_Box.Size = new System.Drawing.Size(224, 20);
			this.kund_Box.TabIndex = 5;
			// 
			// label4
			// 
			...
			// pro_Bearb_Butt
			// 
			this.pro_Bearb_Butt.Location = new System.Drawing.Point(418, 36);
			this.pro_Bearb_Butt.Name = "pro_Bearb_Butt";
			this.pro_Bearb_Butt.Size = new System.Drawing.Size(100, 23);
			this.pro_Bearb_Butt.TabIndex = 3;
			this.pro_Bearb_Butt.Text = "Bearbeiten";
			this.pro_Bearb_Butt.UseVisualStyleBackColor = true;
			// 
			// newPro_Butt
			// 
			this.newPro_Butt.Location = new System.Drawing.Point(418, 7);
			this.newPro_Butt.Name = "newPro_Butt";
			this.newPro_Butt.Size = new System.Drawing.Size(100, 23);
			this.newPro_Butt.TabIndex = 2;
			...
			this.comboBox2.Location = new System.Drawing.Point(55, 9);
        ...
        private System.Windows.Forms.ListBox thät_Box;
        ...
        private System.Windows.Forms.Button ku_new_Butt;
